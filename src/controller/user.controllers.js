...
const updateUserAvatar = asyncHandler(async (req, res) => {
  ...
  console.log("delete Image result: ", deletedAvatar);

  if (!deletedAvatar) {
    throw new ApiError(500, "Deletion of old avatar is Failed");
  }
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
  ...
  const deletedCoverImage = await deleteFromCloudinary(publicId);
  console.log("delete Image result: ", deletedCoverImage);

  if (!deletedCoverImage) {
    throw new ApiError(500, "Deletion of old coverImage is Failed");
  }
...
const getWatchHistory= asyncHandler(async (req, res)=>{
  ...
  return res
        .status(200)
        .json(new ApiResponse(200, user[0]?.watchHistory, "User History successfully fetched"))
})
